...
def dataAddition():
    ...
    with open("working/utils/dataChunks.json", "w", encoding="utf-8") as f:
...
def createEmbeddings():
    ...
    with open("working/utils/dataEmbeddings.pkl", "wb") as f:
        pickle.dump(data, f)
    return embeddings

def createIndex():
    with open("working/utils/dataEmbeddings.pkl", "rb") as f:
        data = pickle.load(f)
    ...
    faiss.write_index(index, "working/utils/dataIndexed.faiss")
