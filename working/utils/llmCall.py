...
def query(prompt):
    ...
    #system - Sets the model’s overall behavior or personality (optional)
    ...
    logging.debug("Respone Received : ", response)

    return response.get("choices", [{}])[0].get("message", {}).get("content", None), response
